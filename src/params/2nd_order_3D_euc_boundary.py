...
class Params:
    """ General parameters """
    dataset_name: str = 'hammer'  # selects dataset, options: LASA, LAIR, LASA_S2, hammer, ABB_R3S3
    results_path: str = 'results/2nd_order_3D_euc_boundary/'
    ...
    ambient_space_dimension: int = 3  # dimensionality of the ambient space
    ...
    boundary_loss_weight: float = 0.1  # 1  # boundary loss weight
    ...
    simulated_trajectory_length: int = 300  # integration length for evaluation
    evaluation_samples_length: int = 30  # integration steps skipped in quantitative evaluation for faster evaluation
