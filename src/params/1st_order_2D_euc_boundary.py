...
class Params:
    ...
    results_path: str = 'results/1st_order_2D_euc_boundary/'
    ...
    learning_rate: float = 9.78366e-5  # 0.0001  # AdamW learning rate
    ...
    stabilization_loss_weight: float = 0.13146  # 0.93  # 1  # stability loss weight
    boundary_loss_weight: float = 0.001  # boundary loss weight
    imitation_window_size: int = 14  # 15  # imitation window size
    stabilization_window_size: int = 12  # 5  # stability window size
    triplet_margin: float = 0.005921  # 1.25e-8  # triplet loss margin
