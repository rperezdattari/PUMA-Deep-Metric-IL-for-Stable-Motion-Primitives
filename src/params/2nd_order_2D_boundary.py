...
class Params:
    ...
    results_path: str = 'results/2nd_order_2D_boundary/'
    ...
    learning_rate: float = 0.00032695  # 0.0001  # AdamW learning rate
    ...
    stabilization_loss_weight: float = 2.6962  # 1  # stability loss weight
    ...
    triplet_margin: float = 0.000165  # 1.25e-4  # triplet loss margin
