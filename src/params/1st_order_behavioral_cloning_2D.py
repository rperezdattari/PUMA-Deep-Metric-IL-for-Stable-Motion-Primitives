...
class Params:
    ...
    results_path: str = 'results/1st_order_behavioral_cloning_2D/'
    ...
    learning_rate: float = 0.0001964  # 0.0001  # 0.0001  # AdamW learning rate
    ...
    imitation_window_size: int = 15  #15  # 15  # imitation window size
