...
class Params:
    ...
    learning_rate: float = 4.4485e-5  # 0.0001  # AdamW learning rate
    ...
    stabilization_loss_weight: float = 0.5854  # 1  # stability loss weight
    ...
    triplet_margin: float = 0.005869  # 1.25e-4  # triplet loss margin
