...
class Params:
    ...
    results_path: str = 'results/2nd_order_2D_no_bound/'
    ...
    learning_rate: float = 0.000327  # 0.0002494  # 0.0001  # AdamW learning rate
    ...
    stabilization_loss_weight: float = 2.69616  # 4.96810  # 1  # stability loss weight
    boundary_loss_weight: float = 0  # boundary loss weight
    imitation_window_size: int = 15  # 15  # imitation window size
    stabilization_window_size: int = 15  # 10  # 2  # stability window size
    triplet_margin: float = 0.0001648  # 1.227e-05  # 4.523e-9  # 1.25e-4  # triplet loss margin
