...
class Params:
    ...
    results_path: str = 'results/1st_order_R3S3_multi_kuka/'
    ...
    stabilization_loss_weight: float = 0.5  # stability loss weight
    ...
    simulated_trajectory_length: int = 600  # integration length for evaluation
