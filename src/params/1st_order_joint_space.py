...
class Params:
    """ General parameters """
    dataset_name: str = 'joint_space'  # options: LASA, LAIR, optitrack, interpolation, joint_space
    results_path: str = 'results/1st_order_joint_space/'
    ...
    manifold_dimensions: int = 6  # dimensionality of the data
    ...
    batch_size: int = 500  # sampling batch size
    ...
    simulated_trajectory_length: int = 800  # integration length for evaluation
    ...
    """ Dataset training """
    length_dataset = 2  # number of primitives in dataset
