...
class Params:
    ...
    learning_rate: float = 0.000195  # 0.0001  # AdamW learning rate
    ...
    stabilization_loss_weight: float = 0.4508  # 1  # stability loss weight
    ...
    triplet_margin: float = 1.0415e-9  # 1.25e-4  # triplet loss margin
