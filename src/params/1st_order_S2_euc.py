...
class Params:
    ...
    learning_rate: float = 0.000132  # 0.0001  # AdamW learning rate
    ...
    stabilization_loss_weight: float = 0.11197  # 1  # stability loss weight
    ...
    triplet_margin: float = 4.31365e-5  # 1.25e-4  # triplet loss margin
