...
class Params:
    """ General parameters """
    dataset_name: str = 'LAIR'  # selects dataset, options: LASA, LAIR, LASA_S2, hammer, ABB_R3S3
    ...
    learning_rate: float = 0.0003988  # 0.0001964  # 0.0001  # AdamW learning rate
    ...
    imitation_window_size: int = 6  # 15  # 15  # imitation window size
